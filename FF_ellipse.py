...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc8 = nn.Linear(neurons, neurons)
        #self.fc9 = nn.Linear(neurons, neurons)
        #self.fc10 = nn.Linear(neurons, neurons)
        
        self.fc11 = nn.Linear(neurons, 2)
...
def train(X,target,epochs,net = Net(),shape='ellipse'):
    ...
    for epoch in range(epochs):
        ...
        if epoch %5000==0:
            ...
            #learning_rate = learning_rate*np.exp()
        ...
        #if abs(prev_loss-loss.item())<0.000001 and lr<=1:
            #learning_rate = learning_rate*1.005
            #print('learning rate to ', learning_rate)
        #prev_loss = loss.item()
    return net
...
if __name__ == "__main__":
    ...
    netTrained = train(X,y,10000,net,shape)
